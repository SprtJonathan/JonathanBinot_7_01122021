...
function createFiltersHTMLCode(array, listDiv, type) {
  listDiv.innerHTML = "";
  for (i = 0; i < array.length; i++) {
    listDiv.innerHTML += `<div id="filter-${type}-${i}" class="filters--selection background--${type}"><span class="filters--selection--text">${array[i]}</span><button class="btn" onclick="removeFilter(${i}, '${type}')"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white" class="bi bi-x-circle" viewBox="0 0 16 16">
